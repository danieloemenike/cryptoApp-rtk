...
import { MoneyCollectOutlined, DollarCircleOutlined, FundOutlined, ExclamationCircleOutlined, StepForwardOutlined, TrophyOutlined, StopOutlined, NumberOutlined, ThunderboltOutlined } from '@ant-design/icons';
...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    { title: '24h Volume', value: `$ ${cryptoDetails?.volume && millify(Number(cryptoDetails?.volume))}`, icon: <ThunderboltOutlined /> },
